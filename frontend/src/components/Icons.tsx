/** Lucide-style 24px stroke icons (ISC). https://lucide.dev */
...
export function IconPredicted(p: Props) {
  return (
    <Svg {...p}>
      <path d="M16 7h6v6" />
...
export function IconRisks(p: Props) {
  return (
    <Svg {...p}>
...
export function IconAdvisor(p: Props) {
  return (
    <Svg {...p}>
...
export function IconPanelClose(p: Props) {
  return (
    <Svg {...p}>
...
export function IconPanelOpen(p: Props) {
  return (
    <Svg {...p}>
      <rect width="18" height="18" x="3" y="3" rx="2" />
      <path d="M9 3v18" />
...
export function IconLanguages(p: Props) {
  return (
    <Svg {...p}>
      <path d="m5 8 6 6" />
...
export function IconDroplet(p: Props) {
  return (
    <Svg {...p}>
...
export function IconVolumeOff(p: Props) {
  return (
    <Svg {...p}>
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
