...
Default focus: **Haldia, Purba Medinipur, West Bengal**. GitHub: [NetRunnerXD/Prithvi AI](https://github.com/NetRunnerXD/Prithvi AI). Public dashboard: Vercel (`deploy/vercel.md`); API: Render (`deploy/render.md`).
